  ...
  return (
    <div className="relative z-10 w-full max-w-md bg-slate-900/60 border border-slate-800 rounded-3xl p-8 backdrop-blur-xl shadow-2xl">
      <div className="text-center mb-8">
        ...
        <p className="text-slate-400 text-sm">Join us to build and share dynamic forms</p>
      </div>
      ...
      <div className="mt-8 text-center border-t border-slate-800/60 pt-6">
        <p className="text-slate-500 text-sm">
          ...
          <Link href={`/login?redirect=${encodeURIComponent(redirect)}`} className="text-teal-400 hover:text-teal-300 font-semibold hover:underline">
            Login Here
          </Link>
        </p>
      </div>
